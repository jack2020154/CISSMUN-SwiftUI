...
let jqAttractions : [Attraction] = [
    Attraction(id:1, name:"Carrefour in Jinqiao (家乐福)", image:"Carrefour" , description: jqDescriptions[0], locationlat: 31.2391253, locationlong: 121.5810592, addressEN: "555 Biyun Road, Pudong District", addressCN: "碧云路555号，浦东新区"),
    Attraction(id:2, name:"Kerry Parkside (浦东嘉里城)", image:"Kerry", description: jqDescriptions[1], locationlat: 31.2124923, locationlong: 121.5622317, addressEN: "1388 Huamu Road, Pudong District", addressCN: "花木路1388号，浦东新区"),
    Attraction(id:3, name:"Science Museum (科技馆)", image:"Science and Tech", description: jqDescriptions[2], locationlat: 31.2180969, locationlong: 121.5410772, addressEN: "2000 Century Avenue, Pudong District", addressCN: "世纪大道2000号，浦东新区"),
    Attraction(id:4, name:"The Fake Market (上海科技馆)", image:"Fake Market", description: jqDescriptions[3], locationlat: 31.2180969, locationlong: 121.5410772, addressEN: "2000 Century Avenue, Pudong District", addressCN: "世纪大道2000号，浦东新区"),
    Attraction(id:5, name:"Century Park (世纪公园)", image:"Century Park", description: jqDescriptions[4], locationlat: 31.2151576, locationlong: 121.5521626, addressEN: "1001 Jinxiu Road, Pudong District", addressCN: "锦绣路1001号，浦东新区")
]
